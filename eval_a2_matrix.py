...
MODELS = [
    ("A2_E_goto_s0", r"runs_gcppo\A2_E_goto_s0"),
    ("A2_E_babyaipickup_s0", r"runs_gcppo\A2_E_babyaipickup_s0"),
    ("A2_E_fetch_s0", r"runs_gcppo\A2_E_fetch_s0"),
    ("A2_shared_seq", r"runs_gcppo\A2_SEQ_step3_fetch_s0"),
    ("A2_shared_joint", r"runs_gcppo\A2_joint_s0"),
]
...
def main():
    ...
    save_long_and_pivot(rows, "a2_eval_matrix", TEST_ENVS)
