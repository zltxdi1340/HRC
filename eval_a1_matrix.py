...
MODELS = [
    ("A1_E_doorkey_s0", r"runs_gcppo\A1_E_doorkey_s0"),
    ("A1_E_unlockpickup_s0", r"runs_gcppo\A1_E_unlockpickup_s0"),
    ("A1_E_unlocklocal_s0", r"runs_gcppo\A1_E_unlocklocal_s0"),
    ("A1_shared_seq", r"runs_gcppo\A1_SEQ_step3_unlocklocal_s0"),
    ("A1_shared_joint", r"runs_gcppo\A1_joint_s0"),
]
...
def main():
    ...
    save_long_and_pivot(rows, "a1_eval_matrix", TEST_ENVS)
