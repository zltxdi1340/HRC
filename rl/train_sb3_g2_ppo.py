...
def main():
    ...
    debug_cb = DebugInfoTensorboardCallback(
        keys=[
            ...
            "debug_g2_drop_attempt_count",
            "debug_g2_toggle_attempt_count",
            "debug_g2_carrying_key",
            "debug_g2_carrying_target",
            "g2_precondition_ok",
        ],
        ep_window=200,
        prefix="g2_debug",
        alias_map={
            ...
            "debug_g2_drop_attempt_count": "drop_cnt",
            "debug_g2_toggle_attempt_count": "toggle_cnt",
            "debug_g2_carrying_key": "carrying_key",
            "debug_g2_carrying_target": "carrying_target",
